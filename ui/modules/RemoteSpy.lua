...
function Log.new(remote)
	...
	button.Icon.Image = icons[remoteClassName] or "rbxassetid://4229806545"
...
scriptContext:SetCallback(function()
	local script =
		"-- This script was generated by a forked Hydroxide's RemoteSpy: https://github.com/SecondNewtonLaw/Hydroxide\n\n"
	...
	if #selected.args == 0 then
		...
		for i = 1, #selectedArgs do
			...
			elseif valueType == "buffer" then
				v = "buffer.fromstring(" .. buffer.tostring(v) .. ")"
			else
				v = toString(v)
			end
